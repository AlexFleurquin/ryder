          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            <article className="h-full flex flex-col items-center text-center" data-aos="fade-up">
              <header className="mb-3">
                <img className="rounded-full inline-flex" src={TestimonialsImage01} width="40" height="40" alt="Testimonial 01" />
                {/* Stars */}
                <div className="mt-4">
            ...
            <article className="h-full flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="200">
              <header className="mb-3">
                <img className="rounded-full inline-flex" src={TestimonialsImage02} width="40" height="40" alt="Testimonial 02" />
                {/* Stars */}
                <div className="mt-4">
                  <div className="flex space-x-1">
                    <button>
            ...
            <article className="h-full flex flex-col items-center text-center" data-aos="fade-up" data-aos-delay="400">
              <header className="mb-3">
                <img className="rounded-full inline-flex" src={TestimonialsImage03} width="40" height="40" alt="Testimonial 03" />
                {/* Stars */}
                <div className="mt-4">
                  <div className="flex space-x-1">
                    <button>
