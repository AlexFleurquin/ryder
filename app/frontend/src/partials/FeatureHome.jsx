...
import FeaturesImage1 from '../images/Motto_Groot.jpg';
import FeaturesImage2 from '../images/Motto_Groot_2.jpg';
import FeaturesImage3 from '../images/Motto_Groot.jpg';
            ...
            <div className="md:w-7/12 lg:w-1/2" data-aos="fade-up">
              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">E Bike</div>
                    <div className="text-slate-500">Parcourez la ville avec votre vélo électrique Ryder, conçu pour vos trajets quotidiens.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">Conciergerie 2.0</div>
                    <div className="text-slate-500">Déplacez-vous en toute sérénité grâce à une assurance vol, un service de réparation à la demande et un support client réactif.</div>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div>
                    <div className="text-slate-800 font-medium mb-1">App connectée</div>
                    <div className="text-slate-500">Laissez-vous guider par notre app, votre nouveau compagnon de route.</div>
                  </div>
                </button>
              </div>
            </div>
